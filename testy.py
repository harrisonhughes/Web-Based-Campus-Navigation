...
paths.append([21, 'translate(380.5,247.5)', 'M0,0 L0,6.5, L0,0'])
...
paths.append([8, 'translate(209,526)', 'M0,0 L71,0 L0,0'])
paths.append([11, 'translate(273,526)', 'M0,0 L20,0 L0,0'])
paths.append([5, 'translate(290,526)', 'M0,0 L0,65.72 L0,0'])
paths.append([5, 'translate(273,452)', 'M0,0 L0,74.5 L0,0'])
...
paths.append([13, 'translate(341.5,585)', 'M0,0 L0,10 L0,0'])
#Union/Lib/Magruder
...
paths.append([12, 'translate(390,526)', 'M0,0 L24,0 L0,0'])
...
paths.append([4, 'translate(339,435)', 'M0,0 L0,17 L0,0'])
paths.append([4, 'translate(331,435)', 'M0,0 L0,17 L0,0'])
#BNB
...
paths.append([5, 'translate(491.5,308.5)', 'M0,0 L-5,5, L0,0'])
paths.append([5, 'translate(486.5,413.5)', 'M0,0 L5,5, L0,0'])
...
#Health/Kirk
paths.append([5, 'translate(326,408)', 'M0,0 91,0, L0,0'])
paths.append([6, 'translate(330,408)', 'M0,0 0,5, L0,0'])
paths.append([6, 'translate(375,408)', 'M0,0 0,5, L0,0'])
paths.append([5, 'translate(310,365)', 'M0,0 L0,15 Q0,43,20,43 Q0,41,0,15'])
paths.append([5, 'translate(349.5,365)', 'M0,0 L0,15 Q0,43,-19.5,43 Q0,41,0,15'])
paths.append([5, 'translate(354,365)', 'M0,0 L0,15 Q0,43,21,43 Q0,41,0,15'])
paths.append([5, 'translate(414,365)', 'M0,0 Q-8,40,-34,43 Q-8,40,0,0'])
paths.append([5, 'translate(354,365)', 'M0,0 Q0,-24,26.5,-24 Q0,-24,0,0'])
paths.append([5, 'translate(414,365)', 'M0,0 Q0,-24,-34.5,-24 Q0,-24,0,0'])
paths.append([5, 'translate(349,341)', 'M0,0 L68,0 L0,0'])
paths.append([5, 'translate(268,365)', 'M0,0 L0,29 L0,0'])
paths.append([21, 'translate(380.5,336)', 'M0,0 L0,5 L0,0'])
#Lib/Kirk
...
kirk = draw.Path(fill='white', stroke='black', stroke_width='.15', transform='translate(370,247.5)')
kirk.M(0,0).A(10.5,10.5,360,1,1,21,0).L(0,0)
d.append(kirk)
...
#violette
buildings.append([293, 469, '''M0,0 L17,0 L17,3 L39,3 L39,0 L58,0 L58,3 L80,3 L80,0 L97,0 L97,17 L94,17
L94,48 L97,48 L97,68 L94,68 L94,99 L97,99 L97,116 L80,116 L80,113 L58,113 L58,116 L39,116 L39,113
L17,113 L17,116 L0,116 L0,99 L3,99 L3,68 L0,68 L0,48 L3,48 L3,17 L0,17 L0,0 L17,0'''])
...
#bnb
buildings.append([428, 287, '''M0,0 L28,0 L28,-6 L22,-6 L22,-24 L40,-24 L40,-6 L34,-6 L34,0 L83,0 L85,2
L85,38 L91.5,38 L91.5,50 L85,50 L85,151 L83,153 L0,153 L0,136 L59,136 L68,127 L68,83 L66,83 L66,71
L68,71 L68,26 L59,17 L0,17 L0,0 L27,0'''])

#missouri
buildings.append([422, 144, '''M0,0 L14,-13 L38,11 L38,-21 L55,-21 L55,11 L79,-13 L93,0 L69,24 L69,28 L90,28
L90,57 69,57 L69,61 L93,85 L79,98 L55,74 L55,106 L38,106 L38,74 L14,98 L0,85 L24,61 L17,55 L17,30 L24,24 L0,0, L14,-13'''])

#power
buildings.append([239, 394, '''M0,0 L42,0 L42,20 L55,20 L55,42 L42,42 L42,38 L20,38 L20,20 L0,20 L0,0 L42,0'''])

#health
buildings.append([296, 415, '''M0,0 L30,0 L30,-2 L38,-2 L38,0 L75,0 L75,-2 L83,-2 L83,0 L107,0 L107,22
L46,22 L46,20 L18,20 L18,22 L0,22 L0,0 L28,0'''])
...
#kirk
buildings.append([370, 260, '''M0,0 L0,-6 L21,-6 L21,0 L33,0 L33,70 L21,70 L21,76 L0,76 L0,70 L-12,70 L-12,0 L0,0'''])
...
opLot.M(0,0).L(107.5,0).L(107.5,32).L(117.5,32).L(117.5,47).L(107.5,47).L(107.5,92).L(117.5,92).L(117.5,108).L(107.5,108).L(107.5,151).L(117.5,151).L(117.5,166).L(107.5,166).L(107.5,203).L(0,203).L(0,0).L(104.5,0)
d.append(opLot)
...
#for key in nodes:
#    for i in nodes[key]:
#        path = draw.Path(d='M0,0' + i, stroke='navy', stroke_width=2, fill='none', transform='translate(205,365)')
#        d.append(path)

#for key in nodes:
#    d.append(draw.Circle(0, 0, 2, fill='red', stroke='none', transform='translate(205,365)'))
